...
public class JFrmListaPrecio extends javax.swing.JInternalFrame {
    ...
    public void guardar(String accion) {
        ...
        switch (accion) {
            case "NUEVO":
                ...
                if (idmoneda == 0) {
                    error += "NO HA SELECCIONADO UNA MONEDA PARA LA LISTA DE PRECIO.\n";
                }
                if (error.isEmpty()) {
                    lp.setIdlista(id);
    ...
    public void recuperarDatos() {
        ...
        if (fila >= 0) {
            ...
            int idmoneda = Integer.parseInt(tablaDatos.getValueAt(fila, 2).toString());
            txtCodigo.setText(id);
            txtDescripcion.setText(descripcion);
            m.setIdmoneda(idmoneda);
            daoMoneda.consultarDatos(m);
            txtCodigoMoneda.setText(""+m.getIdmoneda());
    ...
    private void initComponents() {
        ...
        tablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "<html><p style=\"text-align:center\"><span style=\"color:#000066\"><span style=\"font-family:SansSerif\"><span style=\"font-size:10px\">Código</span></span></span></p></html> ", "<html><p style=\"text-align:right\"><span style=\"color:#000066\"><span style=\"font-family:SansSerif\"><span style=\"font-size:10px\">Descripción</span></span></span></p></html> ", "<html><p style=\"text-align:right\"><span style=\"color:#000066\"><span style=\"font-family:SansSerif\"><span style=\"font-size:10px\">CodigoMoneda</span></span></span></p></html> "
            }
        ) {
            Class[] types = new Class [] {
